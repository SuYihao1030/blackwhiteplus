...
Page({
  ...
  addAddress: function () {
    ...
    if (that.data.name.length == 0) {
      ...
      var provinceId = that.data.pId;
      var cityId = that.data.cId;
      var areaId = that.data.dId;
      var areaInfo = that.data.pName + ',' + that.data.cName + ',' + that.data.dName;
      var address = that.data.detailAddress;
      AV.User.loginWithWeapp();
      var addr = new AV.Object('Adress');
      addr.set('user', AV.User.current());
      addr.set('name', name);
      addr.set('phoneNum', phoneNum);
      addr.set('zipCode', zipCode);
      addr.set('provinceId', provinceId);
      addr.set('cityId', cityId);
      addr.set('areaId', areaId);
      addr.set('areaInfo', areaInfo);
      addr.set('detailAddress', address);
